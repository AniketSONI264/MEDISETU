...
// import useDoctorAuth from "../hooks/getDoctor.js"        
...
//   const { doctor, isAuth, error } = useDoctorAuth();
//   console.log("Details of the doctor :",doctor);
//   const profilePic = doctor?.profilePic || "/MediSetu_Logo_W100.svg";
//   const [isOpen, setIsOpen] = useState(true);
//   const router = useRouter();
//   const closeDrawer = () => {
...
import { useRouter } from "next/navigation";
import toast from "react-hot-toast";
import useDoctorAuth from "../hooks/getDoctor"; // updated hook
import { logoutDoctor } from "../utils/api.js";
const menusByRole = {
  doctor: [
    { label: "Dashboard", icon: Home, href: "/doctor" },
  ...
  if (isAuth === null) {
    return (
      <div className="flex items-center justify-center h-screen">
        <p className="text-teal-700 font-semibold text-lg">Checking authentication...</p>
      </div>
    );
  }
    ...
    <div className="flex h-screen">
      ...
      <div className="flex-grow">
        <header className="fixed top-0 left-0 w-full bg-gradient-to-r from-teal-700 to-teal-500 shadow-lg py-4 px-6 flex justify-between items-center z-50 text-white">
          ...
          {/* <button
            onClick={handleLogout}
            className="bg-red-400 hover:bg-red-600 text-teal-900 px-4 py-2 rounded-lg font-semibold transition-all shadow"
          >
            Logout
          </button> */}
          <button
