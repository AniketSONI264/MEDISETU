...
//     try {
//       await axios.patch(`/api/admin/appointments/${id}/status`, { status });
...
//             className="px-3 py-1 rounded-lg text-sm font-medium bg-green-100 text-green-600 hover:bg-green-200"
//           >
//             Complete
//           </button>
//           <button
...
// import { useAdminAccess } from '@/hooks/useAdminAccess'; // YOUR ACTUAL FILE
...
//   if (!isAdmin) {
//     return null; // Already redirected by hook, nothing to show
//   }
